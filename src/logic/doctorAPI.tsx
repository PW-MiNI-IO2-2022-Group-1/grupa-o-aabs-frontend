...
export function getSlots(start: Date | null, end: Date | null, onlyReserved: string | null, authToken: string, page: number) {
    ...
    let reserved = onlyReserved == null?'':`onlyReserved=${encodeURIComponent(onlyReserved)}&`
